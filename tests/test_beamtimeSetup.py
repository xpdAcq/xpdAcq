...
from xpdacq.beamtimeSetup import _make_clean_env, _start_beamtime, \
    _end_beamtime, _execute_start_beamtime, _check_empty_environment, _load_bt, \
    _execute_end_beamtime, _delete_home_dir_tree
...
class NewBeamtimeTest(unittest.TestCase):
    ...
    def test_check_empty_environment(self):
        ...
        self.assertRaises(SystemExit, lambda: _check_empty_environment(
    ...
    def test_make_clean_env(self):
        ...
        dir_list = [home_dir, conf_dir, tiff_dir, usrconfig_dir, import_dir,
    ...
    def test_bt_creation(self):
        _make_clean_env()
        self.bt = Beamtime(self.PI_name, self.saf_num,
    ...
    def test_start_beamtime(self):
        ...
        self.assertIsInstance(bt,
                              bts.Beamtime)  # there should be a bt object, is there?
        ...
        strtScnLst = ['bt_bt.yml', 'ex_l-user.yml', 'sa_l-user.yml',
                      'sp_ct_0.1.yml', 'sp_ct_0.5.yml', 'sp_ct_1.yml',
                      'sp_ct_5.yml', 'sp_ct_10.yml', 'sp_ct_30.yml']
    ...
    def test_export_userScriptsEtc(self):
        ...
        self.assertTrue(
            os.path.isdir(os.path.join(glbl.home, userScript_dir_tail)))
        self.assertTrue(
            os.path.isdir(os.path.join(glbl.home, config_base_tail)))
        # are files in unpacked dirs?
        self.assertTrue('script.py' in os.listdir(
            os.path.join(glbl.home, userScript_dir_tail)))
