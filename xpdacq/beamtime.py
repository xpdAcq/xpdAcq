...
class ScanPlan(XPD):
    ...
    '''
    def __init__(self, scanplanname, scanplan_type, scanplan_params, shutter=True, livetable=True, verify_write=False, **kwargs):
        self.name = _clean_md_input(scanplanname)
        self.type = 'sp'
...
class Scan(XPD):
    ...
    sample - xpdAcq.beamtime.Sample object
        object that holds sample metadata

    scanplan - xpdAcq.beamtime.ScanPlan object
        scanplan object that defines scans to run
    '''
