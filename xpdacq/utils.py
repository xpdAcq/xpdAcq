...
class ExceltoYaml:
    ...
    def create_yaml(self):
        ...
        ----------
        sa_md_list : list
            a list of metadata dict generated by _pd_dict_to_dict method
